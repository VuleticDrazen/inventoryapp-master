                    ...
                    <form action="/equipment/{{ $equipment->id }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-4 offset-4">
                                <button type="submit" id="edit_equipment_{{$equipment->id}}" class="btn btn-primary btn-block btn-flat mt-4" onclick="confirmEditEquipment({{$equipment->id}},event)">
...
@section('additional_scripts')
    ...
    <script src="{{ asset('js/equipment/edit.js') }}"></script>
@endsection
